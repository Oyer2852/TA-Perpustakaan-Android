...
//                        return true;
        ...
        String url = "http://10.0.2.2/KAPER_SKARIGA_konek/getdata2.php?id="+id;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int a = 0; a < jsonArray.length(); a++) {
                        ...
                        list_data1.add(map);
                        AdapterList2 adapter = new AdapterList2(DetailActivity.this, list_data1);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(AppVar.URL_GET_EMP,id);
                return s;
            }
        }
        ...
        private void showEmployee(String json){
            try {
                ...
                String judul = c.getString(AppVar.TAG_KOTA);
