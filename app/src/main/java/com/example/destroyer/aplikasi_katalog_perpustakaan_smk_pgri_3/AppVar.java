...
public class AppVar {
    ...
    public static final String PESAN_URL = "http://10.0.2.2/KAPER_SKARIGA_konek/pesan.php";
    ...
    public static final String KEY_IDBUKU = "id_buku";
    ...
    public static final String LOGIN_SUCCESS = "id_user";
    public static final String SHARED_PREF_NAME = "myloginapp";
    public static final String LOGGEDIN_SHARED_PREF = "loggedin";
    public static final String ID_SHARED_PREF = "iduser";
    public static final String USERNAME_SHARED_PREF  = "username";
    public static final String EMAIL_SHARED_PREF = "email";
    public static final String IDSP = "asd";
